...
import com.edge.test.xml.reader.IntContainerField;
import com.edge.test.xml.reader.IntDataContainer;
...
public abstract class Page extends PageObject {
	...
	public void fillMandatoryFields(Page page) {
		...
		autoPopulate.populateValues(page, dataContainer.getMandatoryFields());
	}

	public void fillAllFields(Page page) {
		IntDataContainer dataContainer = commonData.getContainer(page.getClass().getSimpleName());
		dataContainer.setActualValues();
		autoPopulate.populateValues(page, dataContainer.getFields());
	}
	...
	public void fillMandatoryFieldsFromAllContainers(Page page) {
		...
		autoPopulate.populateValues(page, dataContainer.getMandatoryFieldsFromAllContainers());
	}

	public void fillAllFieldsFromAllContainers(Page page) {
		IntDataContainer dataContainer = commonData.getContainer(page.getClass().getSimpleName());
		dataContainer.setActualValuesForAllContainers();
		autoPopulate.populateValues(page, dataContainer.getFieldsFromAllContainers());
	}
	...
	public void verifyMandatoryFields(Page page) {
		IntDataContainer dataContainer = commonData.getContainer(page.getClass().getSimpleName());
		dataContainer.setActualValues();
		autoVerify.verifyValues(page, dataContainer.getMandatoryFields());
	}

	public void verifyAllFields(Page page) {
		IntDataContainer dataContainer = commonData.getContainer(page.getClass().getSimpleName());
		dataContainer.setActualValues();
		autoVerify.verifyValues(page, dataContainer.getFields());
	}

	public void verifyMandatoryFieldsFromAllContainers(Page page) {
		IntDataContainer dataContainer = commonData.getContainer(page.getClass().getSimpleName());
		dataContainer.setActualValuesForAllContainers();
		autoVerify.verifyValues(page, dataContainer.getMandatoryFieldsFromAllContainers());
	}

	public void verifyAllFieldsFromAllContainers(Page page) {
		IntDataContainer dataContainer = commonData.getContainer(page.getClass().getSimpleName());
		dataContainer.setActualValuesForAllContainers();
		autoVerify.verifyValues(page, dataContainer.getFieldsFromAllContainers());
	}
	...
	public void shouldExist(Page page, int... waitTime) {
		...
		assertThat("User is not in the page : " + page.getClass().getSimpleName(),
				page.getUniqueElementInPage().isVisible());
	}
